...
export function scanToolMarkupTagAt(text: string, start: number): ToolMarkupTag | null {
...
export function findToolMarkupTag(text: string, from: number): ToolMarkupTag | null {
